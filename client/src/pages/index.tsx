...
import { Context as CurrentPokemonModalContext } from '../core/contexts/currentPokemonModalContext';
...
import ModalCard from '../core/components/ModalCard/ModalCard';
...
const IndexPage = () => {
  ...
  return (
    <>
      <CurrentPokemonModalContext.Provider value={{ pokemon, setPokemon }}>
        <ModalCard />
        <Container>
      ...
      </CurrentPokemonModalContext.Provider>
    </>
  );
};
